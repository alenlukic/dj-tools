...
CONFIG = {
    ...
    "HARMONIC_MIXING": {
        "TRANSITION_MATCH_WEIGHTS": {
            ...
            "VOCAL_CLASH": _float("HM_WEIGHT_VOCAL_CLASH", 0.04),
            "DANCEABILITY": _float("HM_WEIGHT_DANCEABILITY", 0.03),
            "ENERGY": _float("HM_WEIGHT_ENERGY", 0.02),
            "TIMBRE": _float("HM_WEIGHT_TIMBRE", 0.02),
            "INSTRUMENT_SIMILARITY": _float("HM_WEIGHT_INSTRUMENT_SIMILARITY", 0.01),
        },
