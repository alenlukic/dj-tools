"""Deprecated: SegmentedMeanMelSpectrogram feature extractor.

This module is retained only for legacy data-pipeline compatibility
(create_transition_match_rows.py). New code should use
src.feature_extraction.compact_descriptor.CompactDescriptor instead.
"""
import librosa
import numpy as np

from src.models.feature_value import FeatureValue
from src.feature_extraction.deprecated.config import (
    Feature,
    NUM_MELS,
    NUM_ROW_CHUNKS,
    OVERLAP_WINDOW,
...
from src.feature_extraction.config import SAMPLE_RATE
